...
from tiktok_manager import utils
...
class AdAccounts(Schema):
    ...
    def pre_process_data(
        self, data: typing.List[typing.Dict], **kwargs: typing.Any
    ) -> typing.Dict:
...
class CreativeCreate(Schema):
    ...
    identity_authorized_bc_id = fields.Str(
        required=False, data_key="identity_authorized_bc_id"
    )
    ...
    impression_tracking_url = fields.Str(
        required=False, data_key="impression_tracking_url"
    )
    click_tracking_url = fields.Str(required=False, data_key="click_tracking_url")
    video_view_tracking_url = fields.Str(
        required=False, data_key="video_view_tracking_url"
    )
    ...
    shopping_ads_fallback_type = fields.Str(
        required=False, data_key="shopping_ads_fallback_type"
    )
    shopping_ads_deeplink_type = fields.Str(
        required=False, data_key="shopping_ads_deeplink_type"
    )
    shopping_ads_video_package_id = fields.Str(
        required=False, data_key="shopping_ads_video_package_id"
    )
    promotional_music_disabled = fields.Boolean(
        required=False, data_key="promotional_music_disabled"
    )
    ...
    brand_safety_postbid_partner = fields.Str(
        required=False, data_key="brand_safety_postbid_partner"
    )
    brand_safety_vast_url = fields.Str(required=False, data_key="brand_safety_vast_url")
    viewability_postbid_partner = fields.Str(
        required=False, data_key="viewability_postbid_partner"
    )
    ...
    item_group_ids = fields.List(
        fields.Str(), required=False, data_key="item_group_ids"
    )
    ...
    vertical_video_strategy = fields.Str(
        required=False, data_key="vertical_video_strategy"
    )
    dynamic_destination = fields.Str(required=False, data_key="dynamic_destination")
    instant_product_page_used = fields.Boolean(
        required=False, data_key="instant_product_page_used"
    )
    ...
    disclaimer_clickable_texts = fields.List(
        fields.Dict(), required=False, data_key="disclaimer_clickable_texts"
    )
    showcase_products = fields.List(
        fields.Dict(), required=False, data_key="showcase_products"
    )
...
class AdCreate(Schema):
    ...
    creatives = fields.Nested(
        CreativeCreate, many=True, required=True, data_key="creatives"
    )


class AdUpdate(AdCreate):
    creatives = fields.Nested(
        CreativeUpdate, many=True, required=True, data_key="creatives"
    )
...
class CampaignCreate(Schema):
    ...
    budget_optimize_on = fields.Boolean(
        required=False, data_key="budget_optimize_on", default=False
    )
    ...
    campaign_app_profile_page_state = fields.Str(
        required=False, data_key="campaign_app_profile_page_state"
    )
    special_industries = fields.List(
        fields.Str(), required=False, data_key="special_industries"
    )
    rf_campaign_type = fields.Str(required=False, data_key="rf_campaign_type")
    campaign_product_source = fields.Str(
        required=False, data_key="campaign_product_source"
    )
...
class AdGroupCreate(Schema):
    ...
    request_id = fields.Str(required=False, data_key="request_id")
    comment_disabled = fields.Boolean(
        required=False, data_key="comment_disabled", default=False
    )
    app_id = fields.Str(required=False, data_key="app_id")
    ...
    shopping_ads_retargeting_type = fields.Str(
        required=False, data_key="shopping_ads_retargeting_type"
    )
    shopping_ads_retargeting_actions_days = fields.Number(
        required=False, data_key="shopping_ads_retargeting_actions_days"
    )
    included_custom_actions = fields.List(
        fields.Dict, required=False, data_key="included_custom_actions"
    )
    excluded_custom_actions = fields.List(
        fields.Dict, required=False, data_key="excluded_custom_actions"
    )
    store_id = fields.Str(required=False, data_key="store_id")
    store_authorized_bc_id = fields.Str(
        required=False, data_key="store_authorized_bc_id"
    )
    ...
    creative_material_mode = fields.Str(
        required=False, data_key="creative_material_mode"
    )
    audience_ids = fields.List(fields.Str(), required=False, data_key="audience_ids")
    excluded_audience_ids = fields.List(
        fields.Str(), required=False, data_key="excluded_audience_ids"
    )
    ...
    interest_category_ids = fields.List(
        fields.Str(), required=False, data_key="interest_category_ids"
    )
    interest_keyword_ids = fields.List(
        fields.Str(), required=False, data_key="interest_keyword_ids"
    )
    ...
    operating_systems = fields.List(
        fields.Str(), required=False, data_key="operating_systems"
    )
    network_types = fields.List(fields.Str(), required=False, data_key="network_types")
    device_price_ranges = fields.List(
        fields.Number, required=False, data_key="device_price_ranges"
    )
    ...
    device_model_ids = fields.List(
        fields.Str(), required=False, data_key="device_model_ids"
    )
    household_income = fields.List(
        fields.Str(), required=False, data_key="household_income"
    )
    ...
    secondary_optimization_event = fields.Str(
        required=False, data_key="secondary_optimization_event"
    )
    ...
    video_download_disabled = fields.Boolean(
        required=False, data_key="video_download_disabled", default=False
    )
    blocked_pangle_app_ids = fields.List(
        fields.Str(), required=False, data_key="blocked_pangle_app_ids"
    )
    ...
    catalog_id = fields.Str(required=False, data_key="catalog_id")
    product_set_id = fields.Str(required=False, data_key="product_set_id")
    catalog_authorized_bc_id = fields.Str(
        required=False, data_key="catalog_authorized_bc_id"
    )
    ...
    adgroup_app_profile_page_state = fields.Str(
        required=False, data_key="adgroup_app_profile_page_state"
    )
    contextual_tag_ids = fields.List(
        fields.Str(), required=False, data_key="contextual_tag_ids"
    )
    purchase_intention_keyword_ids = fields.List(
        fields.Str(), required=False, data_key="purchase_intention_keyword_ids"
    )
    share_disabled = fields.Boolean(
        required=False, data_key="share_disabled", default=False
    )
    category_exclusion_ids = fields.List(
        fields.Str(), required=False, data_key="category_exclusion_ids"
    )
    vertical_sensitivity_id = fields.Str(
        required=False, data_key="vertical_sensitivity_id"
    )
...
class VideoDetails(Schema):
    ...
    preview_url_expire_time = fields.Str(
        required=True, data_key="preview_url_expire_time"
    )
    signature = fields.Str(required=True, data_key="signature")
    file_name = fields.Str(required=True, data_key="file_name")
    create_time = fields.Str(required=True, data_key="create_time")
    ...
    allowed_placements = fields.List(
        fields.Str(), required=True, data_key="allowed_placements"
    )
...
class CampaignInsights(
    ResourceInsights, CampaignInsightMetrics, CampaignInsightDimensions
):
    pass


class AdGroupInsights(
    ResourceInsights, AdGroupInsightMetrics, AdGroupInsightDimensions
):
    pass
