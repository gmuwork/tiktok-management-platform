...
from tiktok_manager import enums as source_enums
    ...
    def from_service_and_resource_type(
        ...
        return {
            ServiceType.AUCTION: {
                ...
                source_enums.ResourceType.AD_GROUP: DataLevel.AUCTION_ADGROUP,
                source_enums.ResourceType.AD: DataLevel.AUCTION_AD,
            },
            ServiceType.RESERVATION: {
                source_enums.ResourceType.CAMPAIGN: DataLevel.RESERVATION_CAMPAIGN,
                source_enums.ResourceType.AD_GROUP: DataLevel.RESERVATION_ADGROUP,
